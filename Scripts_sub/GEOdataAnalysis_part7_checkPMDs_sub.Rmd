---
title: "GEO data sets_PMD analysis_sub"
author: "Qianhui"
date: "14/01/2019"
...
## 2.1 Select probes for PMDs (samples from first trimester)
```{r}
...
## 2.2 Select probes for PMDs (samples from second trimester)
```{r}
# T2 samples===========================
...
## 2.3 Select probes for PMDs (samples from term)
```{r}
# Term samples==============================
...
tiff(filename = "/home/qianhui/DNAme/Process_decidual/figures/GvizPMDchr21_T1samples_v2_sub.tiff", 
...
## save as tiff
tiff(file = "/home/qianhui/DNAme/Process_decidual/figures/AllPMDsMeanViolinPlot_sub.tiff", 
...
saveRDS(AllPMDsMeanViolinPlot, file = "/home/qianhui/DNAme/Process_decidual/RDSfiles/AllPMDsMeanViolinPlot_sub.rds")
