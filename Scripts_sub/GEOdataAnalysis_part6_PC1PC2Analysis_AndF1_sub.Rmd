---
title: "PC1Analysis_sub"
author: "Qianhui"
date: "12/17/2018"
output: html_document
---

This document is mainly for part6 of the GEO data set analysis, that is pull out PC1 probes, clustering samples using PC1 and PC2, and test correlation between PC1/PC2 and factors (including Tissue types, Trimester, sex, study).
...
# tiff(file = "/home/qianhui/DNAme/Process_decidual/figures/Placenta_Dim1top2percProbePlot_ForOutlier_T1_sub.tiff",
...
# saveRDS(placenta_beta_dim1Top2perc.df_T1, file = "/home/qianhui/DNAme/Process_decidual/RDSfiles/placenta_beta_dim1Top2perc.df_T1_sub.rds")
...
# tiff(file = "/home/qianhui/DNAme/Process_decidual/figures/Placenta_Dim1top2percProbePlot_ForOutlier_T2_residual_sub.tiff",
...
# saveRDS(placenta_beta_dim1Top2perc.df_T2, file = "/home/qianhui/DNAme/Process_decidual/RDSfiles/placenta_beta_dim1Top2perc.df_T2_sub.rds")
...
# tiff(file = "/home/qianhui/DNAme/Process_decidual/figures/Placenta_Dim1top2percProbePlot_ForOutlierTerm_sub.tiff",
#      width = 20, height = 12, units = "cm", res = 300)
# theme_set(theme_bw())
# outlierDim1Plot_Term
# dev.off()
...
# saveRDS(placenta_beta_dim1Top2perc.df_Term, file = "/home/qianhui/DNAme/Process_decidual/RDSfiles/placenta_beta_dim1Top2perc.df_Term_sub.rds")
