...
new_plotDF <- data.frame(x=Control551_M$PCA_control$ind$coord[,1], 
    y=Control551_M$PCA_control$ind$coord[,2],
    GA = Control551_M$phenoDataAll$Gestation,
    FetalSex= Control551_M$phenoDataAll$Fetal_Sex,
    Tissue= Control551_M$phenoDataAll$Sample,
    Trimester=Control551_M$phenoDataAll$Trimester,
    Study=Control551_M$phenoDataAll$Study
)
