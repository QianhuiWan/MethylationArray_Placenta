...
I did PCA on control porbes, so we can see whether there are bach effects between different studies. But notice the intensity of control probes were not preprocessed since in preprocess methods, control probes were filtered out automaticly.
