...
GSE98224.meta_v1 <- GSE98224.meta %>% 
  ...
  mutate(Additional_Info_2= `previous miscarriage:ch1`) %>%  #outliers
  mutate(Fetal_Sex= str_replace_all(`gender:ch1`, c('F'='Female', 'M'='Male'))) %>% 
...
## read our study
GEO_phenotypes_EPIC_ourStudy <- GEO_phenotypes[GEO_phenotypes$ArrayType%in%'EPIC' & GEO_phenotypes$Study%in%'ourStudy',]
...
GEO_phenotypes_EPIC <- GEO_phenotypes[GEO_phenotypes$ArrayType%in%'EPIC' & !(GEO_phenotypes$Study%in%'ourStudy'),]
