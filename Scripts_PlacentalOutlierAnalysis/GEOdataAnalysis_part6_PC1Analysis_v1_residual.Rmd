...
saveRDS(PCA_Placenta_M_T2,
file = "/home/qianhui/DNAme/figures-draftGA-analysis/PCA_Placenta_M_T2_Bvalues.rds")
...
## plot box plot for beta values of Dim1_top2perc porbes
## manipulate data frames
PhenodataPlacenta_T2$Outlier <- factor(ifelse(PhenodataPlacenta_T2$Additional_Info%in%"Outlier" | PhenodataPlacenta_T2$Sample_name%in%c("GSM1702177_7970368142_R05C02", "GSM1947213_6008581028_R01C01"), 
                                              "Outlier", "Standard"))
...
PhenodataPlacenta$OutlierAdd2 <- factor(ifelse(PhenodataPlacenta$Additional_Info%in%"Outlier" |
   PhenodataPlacenta$Sample_name%in%c("GSM1702177_7970368142_R05C02", "GSM1947213_6008581028_R01C01"),
                                        "Outlier", "Standard"))

phenoDataPlacenta.df <- PhenodataPlacenta %>% as.data.frame(stringsAsFactors=FALSE) %>%
  dplyr::select(c("Sample_name", "Outlier", "OutlierAdd2"))
...
outlierSampNames <- placenta_beta_dim1Top2perc.df[placenta_beta_dim1Top2perc.df$OutlierAdd2%in%"Outlier",]$Sample_name %>% unique()
