...
This document is mainly for part4 of the GEO data set analysis, that is the quality control (check fetal sex & genotypes) of data sets from different tissue types.
