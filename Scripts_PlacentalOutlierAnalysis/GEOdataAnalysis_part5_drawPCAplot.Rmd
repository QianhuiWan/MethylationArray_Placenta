...
# PCA_Placenta_M <- FactoMineR::PCA(base::t(NormMAll))
...
# Mnorm_NoT3 <-  NormMAll[,colnames(NormMAll)%in%PhenodataNoT3$Sample_name]
# 
...
# PCA435 <- ggplotPCA(PCA_Placenta_M = PCA_NoT3, Matched_pd = PhenodataNoT3, value = "NoT3NormMAll")
