...
TissueRGsetInfo <- data_frame(
  TissueRGsetNames=c("GEO_RGset_450k_normalPlacenta_v1", "GEO_RGset_EPIC_normalPlacenta",
                     "GEO_RGset_EPIC_normalPlacenta_ourStudy",
                      ...
                      "GEO_RGset_450k_MaternalBlood_v1", "GEO_RGset_450k_mesenchyme",
                      "GEO_RGset_450k_trophoblast", 
                      "GEO_RGset_450k_UC", "GEO_RGset_450k_UCB"
                      ),
  TissueTypes=c(rep("Placenta", 3), rep("Amnion", 2), rep("Chorion", 2), rep("Decidua",2),
...
plotMDSFUN <- function(Normal_betaNorm, Tissue, PhenoData, Array, Study,...){
  registerDoParallel(cores = 10)
